  ...
  render() {
    return (
      <div>
        ...
        <button type="primary" onClick={() => this.props.setAdd(2)}>加</button>
        <button type="primary" onClick={() => this.props.setRemove(2)}>减</button>
        <button type="primary" onClick={() => this.props.getCheng(3)}>乘</button>
        <button type="primary" onClick={() => this.props.getChu(2)}>除</button>
        <button onClick={
            () => {
